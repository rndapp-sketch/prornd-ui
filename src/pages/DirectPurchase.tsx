...
//                     // Arriving via the Other-PI flow: this purchase is charged to
//                     // another PI's project, which they supply at their approval step —
//                     // default the register-for toggle to "Other" and clear any project
//                     // fields so they aren't left stale from a previous draft.
//                     if (searchParams.get('other_pi') === '1') {
//                         initialData.register_for = 'Other';
//                         if (!projectName) {
