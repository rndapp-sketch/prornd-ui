        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <h3 className="font-bold text-zinc-900 dark:text-zinc-100 mb-1">Pending Tasks</h3>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="p-2.5 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg group-hover:bg-[#D97757]/10 transition-colors">
                  <Layers className="h-5 w-5 text-emerald-600 dark:text-emerald-400 group-hover:text-[#D97757]" />
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 shadow-sm overflow-hidden">
              ...
              <div className="divide-y divide-zinc-100 dark:divide-zinc-700/50">
                {isLoading ? (
                  ...
                  <div className="p-8 text-center text-zinc-400">
                    <ClipboardList className="h-8 w-8 mx-auto mb-2 text-zinc-300" />
