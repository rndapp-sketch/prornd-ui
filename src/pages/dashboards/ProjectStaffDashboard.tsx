        ...
        <div className="max-w-7xl mx-auto">
          ...
          <header className="mb-8">
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-4xl font-bold text-black ">Staff Dashboard</h1>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              <div className="flex items-center mb-4 gap-3"><FileText className="size-7" /><h3 className="text-xl font-bold text-black ">My Forms Overview</h3></div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              <div className="flex items-center mb-4 gap-3"><Megaphone className="size-7" /><h3 className="text-xl font-bold text-black ">Recent Status Updates</h3></div>
          ...
          <section className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
            <h3 className="text-xl font-bold mb-4 text-black ">Quick Resources</h3>
            <ul className="space-y-3 border-t border-gray-200 pt-4">
              <li><a href="#" className="flex items-center text-black hover:underline group font-semibold"><FileText className="size-5 mr-3 text-gray-500" /><span className="group-hover:text-[#0EA5A4]">Download Form Templates</span></a></li>
              <li><a href="#" className="flex items-center text-black hover:underline group font-semibold"><LifeBuoy className="size-5 mr-3 text-gray-500" /><span className="group-hover:text-[#0EA5A4]">View Travel Policy</span></a></li>
            </ul>
          </section>
