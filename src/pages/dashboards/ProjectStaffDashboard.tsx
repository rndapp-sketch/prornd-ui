        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <h3 className="font-bold text-zinc-900 dark:text-zinc-100 mb-1">My Pending Tasks</h3>
            ...
            >
              ...
              <h3 className="font-bold text-zinc-900 dark:text-zinc-100 mb-1">My Submissions</h3>
            ...
            >
              ...
              <h3 className="font-bold text-zinc-900 dark:text-zinc-100 mb-1">My History</h3>
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
