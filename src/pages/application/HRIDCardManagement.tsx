...
const HRIDCardManagement: React.FC = () => {
    ...
    const { data: cardList, isLoading, mutate: refreshList } = useFrappeGetDocList<IDCardRecord>(
        'Employee ID Card',
        {
            fields: ['*'],
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <IdCardOptionSelect
                                                ...
                                                onChange={v => setEditForm(prev => ({ ...prev, designation__: v }))}
                                        ...
                                        <div>
                                            ...
                                            <IdCardOptionSelect
                                                ...
                                                onChange={v => setEditForm(prev => ({ ...prev, department_name__: v }))}
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 border-t border-zinc-200 dark:border-zinc-700">
                                        <div>
                                            ...
                                            />
                                            {photoEditPreview && (
                                                <img src={getUploadedImageUrl(photoEditPreview)} alt="Preview" className="w-16 h-20 mt-2 object-cover rounded border border-zinc-200 dark:border-zinc-700" />
                                            )}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            />
                                            {signEditPreview && (
                                                <img src={getUploadedImageUrl(signEditPreview)} alt="Preview" className="h-12 mt-2 object-contain rounded border border-zinc-200 dark:border-zinc-700 bg-white p-1" />
                                            )}
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="text-center">
                                            ...
                                            <div className="w-24 h-28 rounded-lg overflow-hidden border-2 border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center">
                                                {selectedCard.photo_path__ ? (
                                                    <img
                                                        src={getUploadedImageUrl(selectedCard.photo_path__)}
                                                        alt="Staff Photo"
                                        ...
                                        <div className="text-center">
                                            ...
                                            <div className="w-36 h-20 rounded-lg overflow-hidden border-2 border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 p-1.5 flex items-center justify-center">
                                                {selectedCard.sign_path__ ? (
                                                    <img
                                                        src={getUploadedImageUrl(selectedCard.sign_path__)}
                                                        alt="Staff Signature"
