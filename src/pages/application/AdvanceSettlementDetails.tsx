...
import { ArrowLeft, Check, DownloadIcon, Save } from "lucide-react";
                  ...
                  <table className="w-full text-sm text-left">
                    <thead className="bg-[#EEF2FF] dark:bg-blue-950/20 text-[#71717A] dark:text-[#A1A1AA] uppercase font-semibold text-xs">
                      <tr>
                        ...
                        <th className="px-4 py-3 border-b border-[#E4E4E7] dark:border-[#3F3F46] text-center">
                          Attachments
                        </th>
                      </tr>
                    </thead>
                      ...
                      {data.expenditure_details.map((item, idx) => {
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-[#71717A] dark:text-[#A1A1AA]">
                            {item.vendors_name || item.vendor_name || "-"}
                          </td>
                          <td className="px-4 py-3 text-[#71717A] dark:text-[#A1A1AA]">
                          ...
                          <td className="px-4 py-3 text-center">
                            {attachment ? (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center gap-1 px-3 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-semibold rounded-md hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors"
                              >
                                <FileTextIcon className="w-3.5 h-3.5" />
                                View
                              </a>
                            ) : (
                              <span className="text-[#A1A1AA] dark:text-[#71717A] text-xs italic">None</span>
                            )}
                          </td>
                        </tr>
                        );
