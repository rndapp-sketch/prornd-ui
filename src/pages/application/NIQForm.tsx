...
//         placeholder={placeholder}
//         style={{ width: `${Math.max((defaultValue?.length ?? 0) + 2, size) * 7.5}px`, ...style }}
//     />
// );
...
//     const [customRules, setCustomRules] = useState<{ id: number; text: string }[]>([]);

//     const docId = id ?? (location.state as any)?.application?.id ?? '';
...
//     const projectCode = igf?.igf_project_code ?? docId.toUpperCase();
...
//                                         <strong>{indenterName}</strong>
//                                         {designation && <span style={{ display: 'block', marginTop: '2px' }}>{designation}</span>}
//                                         {department && <span style={{ display: 'block', color: '#444' }}>{department}</span>}
//                                     </td>
//                                 </tr>
//                             </tbody>
//                         </table>
...
//                                     </tbody>
//                                     <tfoot>
//                                         <tr className="niq-tfoot" style={{ fontWeight: 'bold', background: '#efefef' }}>
//                                             <td colSpan={3} style={{ ...tdStyle, textAlign: 'right', fontWeight: 'bold', background: '#efefef' }}>Grand Total</td>
//                                             <td style={{ ...tdCenterStyle, background: '#efefef' }}>{totalQty}</td>
//                                             <td style={{ ...tdRightStyle, background: '#efefef' }}></td>
//                                             <td style={{ ...tdRightStyle, background: '#efefef' }}>{fmt(totalAmt)}</td>
//                                         </tr>
//                                     </tfoot>
//                                 </table>
//                             </div>
...
//                             {/* Dynamically added custom rules */}
//                             {customRules.map((rule, idx) => (
//                                 <li key={rule.id} className="niq-li relative group" style={{ display: 'list-item' }}>
//                                     <textarea
//                                         className="niq-input"
//                                         style={{
//                                             width: 'calc(100% - 20px)',
...
//                                         }}
//                                         rows={1}
//                                         placeholder="[Add additional point/rule here]"
//                                         value={rule.text}
//                                         onChange={(e) => {
...
//                                     />
//                                     <button
//                                         className="no-print absolute top-0 -right-4 text-red-500 opacity-50 hover:opacity-100 p-1 bg-white dark:bg-zinc-900 rounded"
...
//                             <li className="no-print" style={{ listStyle: 'none' }}>
//                                 <button
//                                     className="p-1 px-3 mt-1 text-xs font-semibold bg-red-50 hover:bg-red-100 border border-red-200 text-red-700 rounded transition-colors"
//                                     onClick={() => setCustomRules([...customRules, { id: Date.now(), text: '' }])}
//                                 >
