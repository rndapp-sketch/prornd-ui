...
const SelectionCommitteeReportForm: React.FC = () => {
    ...
    return (
        <>
            <style>{`
            @media print {
                @page { size: A4; margin: 5mm 12mm 18mm 12mm; }
            ...
            <div id="scr-print-root" className="bg-[#FAFAF9] dark:bg-[#18181B] min-h-screen">
                ...
                ============================================================ */}
                    {(() => {
                        ...
                        return (
                            <div className="scr-print-layout" style={{ fontFamily: '"Times New Roman", Times, serif', fontSize: '9pt', color: '#000', background: '#fff', padding: '0 2mm' }}>
                                {/* Fixed footer */}
                                            ...
                                            <table style={tbl}><thead>
                                                ...
                                                {rows.length === 0 ? (
                                                    ...
                                                    <tr key={row.id || i}>
                                                        ...
                                                        <td style={{ ...cell(), textAlign: 'center', fontSize: '7.5pt' }}>{formData.upfa_project_duration || '—'}</td>
                    ...
                    <div className="scr-form-content grid grid-cols-1 gap-6">
                        ...
                        <div className="space-y-6">
                            <FrappeCard>
                                ...
                                {/* Action Bar */}
                                <div className="scr-action-bar bg-zinc-50 dark:bg-zinc-800/50 border-t border-zinc-200 dark:border-zinc-800 p-6 flex items-center justify-between">
                                    <div className="text-sm text-zinc-500">
                                        {(editDocName || savedDocName) &&
                                            `Last updated: ${new Date().toLocaleTimeString()}`}
                                    </div>
