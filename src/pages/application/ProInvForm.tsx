    ...
    return (
        <div className="w-full">
            <input
                ...
                maxLength={maxLength}
                className={`bg-transparent border-b border-transparent hover:border-zinc-300 dark:hover:border-zinc-700 focus:border-[#D97757] focus:bg-zinc-50 dark:focus:bg-zinc-800/40 outline-none transition-all px-1 py-0.5 rounded font-medium text-inherit w-full [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ${className}`}
            />
            <CharLimitAlert value={value} maxLength={maxLength} className="mt-0.5" />
        </div>
    );
};
...
const InlineTextarea = ({
    ...
    <div className="w-full">
        ...
        />
        <CharLimitAlert value={value} maxLength={FIELD_CHAR_LIMITS.Text} className="mt-0.5" />
    </div>
);
                ...
                <table class="item-table">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="text-align: center; width: 6%;">SAC</th>
                            <th rowspan="2" style="text-align: center; width: 6%;">Discount<br/>(if any)</th>
                            <th rowspan="2" style="text-align: right; width: 14%;">Taxable Value</th>
                                ...
                                <table className="w-full table-fixed text-left border-collapse text-[11px]">
                                    <thead>
                                        <tr className="bg-zinc-50 dark:bg-zinc-800/50 border-b border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200">
                                            ...
                                            <th rowSpan={2} className="px-2 py-2 font-bold border-r border-b border-zinc-200 dark:border-zinc-800 w-[18%]">Item Description</th>
                                            ...
                                            <th rowSpan={2} className="px-2 py-2 text-center font-bold border-r border-b border-zinc-200 dark:border-zinc-800 w-[6%]">Discount<br/>(if any)</th>
                                            <th rowSpan={2} className="px-2 py-2 text-right font-bold border-r border-b border-zinc-200 dark:border-zinc-800 w-[14%]">Taxable Value</th>
