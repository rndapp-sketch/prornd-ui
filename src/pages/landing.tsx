...
const LandingPage: React.FC = () => {
    ...
    return (
        <div className="bg-stone-50 text-gray-900 font-sans">
            ...
            <main className="container mx-auto px-6 py-16 space-y-20">
                ...
                <section id="about" className="scroll-mt-24">
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h2 className="text-4xl font-bold text-gray-900 mb-6">Welcome to R&D at IIT Guwahati</h2>
                ...
                <section id="research" className="scroll-mt-24">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold text-gray-900 mb-3">Our Research Areas</h2>
                        <p className="text-lg text-gray-600 font-medium">Exploring the frontiers of science and technology.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={idx} className="bg-white p-6 rounded-lg border-2 border-gray-900 shadow-[2px_2px_0px_rgba(0,0,0,0.1)] hover:shadow-[4px_4px_0px_rgba(0,0,0,0.1)] hover:translate-y-[-2px] transition-all duration-200">
                                ...
                                <h3 className="font-bold text-xl mb-2 text-gray-900">{area.title}</h3>
                ...
                {/* Facilities Section */}
                <section id="facilities" className="scroll-mt-24 bg-white border-2 border-gray-900 rounded-lg p-8 shadow-[4px_4px_0px_rgba(0,0,0,0.1)]">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold text-gray-900 mb-2">State-of-the-Art Facilities</h2>
                        <p className="text-gray-600 font-medium">Empowering research with world-class infrastructure.</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={idx} className="text-center p-4 hover:bg-stone-50 rounded-lg transition-colors">
                                <div className="mx-auto w-16 h-16 bg-stone-100 border-2 border-gray-900 rounded-full flex items-center justify-center text-gray-800 mb-4">
                                    {facility.icon}
                                </div>
                                <h3 className="font-bold text-lg mb-2 text-gray-900">{facility.title}</h3>
                ...
                <section id="publications" className="scroll-mt-24">
                    ...
                    <div className="grid gap-4">
                        {[
                            ...
                            <div key={idx} className="bg-white p-5 rounded-lg border-2 border-gray-900 shadow-[2px_2px_0px_rgba(0,0,0,0.1)] hover:bg-blue-50 transition-colors cursor-pointer group">
                                <h3 className="font-bold text-lg text-blue-800 group-hover:underline decoration-2 underline-offset-2">{pub.title}</h3>
                                <p className="text-sm text-gray-600 mt-2 font-medium">{pub.author}</p>
                                <p className="text-xs text-gray-500 italic mt-1 border-t border-gray-200 pt-2 inline-block">{pub.journal}</p>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <section id="events" className="scroll-mt-24">
                    <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">Upcoming Events</h2>
                    <div className="grid md:grid-cols-2 gap-8">
                        {[
                            ...
                            <div key={idx} className="bg-white rounded-lg border-2 border-gray-900 shadow-[4px_4px_0px_rgba(0,0,0,0.1)] overflow-hidden flex items-stretch hover:translate-y-[-2px] transition-transform">
                                ...
                                <div className="p-6 flex flex-col justify-center">
                                    ...
                                    <a href="#" className="font-bold text-sm text-gray-900 hover:text-blue-600 underline decoration-2 underline-offset-4">Register Now</a>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-start">
                    <section id="news" className="lg:col-span-2 scroll-mt-24">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={idx} className="flex flex-col sm:flex-row items-start gap-4 bg-white p-5 rounded-lg border-2 border-gray-900 shadow-[2px_2px_0px_rgba(0,0,0,0.1)]">
                                    ...
                                    <div>
                                        <span className="inline-block px-2 py-0.5 rounded text-xs font-bold bg-stone-100 text-gray-500 mb-2">{news.date}</span>
                                        <h3 className="font-bold text-lg text-gray-900 hover:text-blue-600 transition-colors leading-snug cursor-pointer">{news.title}</h3>
                                        <p className="text-gray-600 mt-2 text-sm">{news.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                        <div className="text-center mt-8">
                            <button className="text-gray-900 font-bold border-b-2 border-gray-900 hover:text-blue-600 hover:border-blue-600 transition-colors pb-1">View All News &rarr;</button>
                        </div>
                    </section>
                    ...
                    <aside id="updates" className="scroll-mt-24">
                        <div className="bg-yellow-50 p-6 rounded-lg border-2 border-gray-900 shadow-[4px_4px_0px_rgba(0,0,0,0.1)] sticky top-24 relative">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">Updates & Links</h3>

                            <div className="mb-8">
                                <h4 className="font-bold text-sm uppercase tracking-wider text-gray-500 mb-4 border-b-2 border-gray-200 pb-2">Latest Updates</h4>
                                <ul className="space-y-4 text-sm font-medium">
                                    ...
                                    <li><a href="#" className="block text-gray-700 hover:text-blue-700">Guidelines for project submission updated.</a></li>
                                    <li><a href="#" className="block text-gray-700 hover:text-blue-700">Upcoming workshop on IPR.</a></li>
                                </ul>
                            </div>

                            <div>
                                <h4 className="font-bold text-sm uppercase tracking-wider text-gray-500 mb-4 border-b-2 border-gray-200 pb-2">Quick Links</h4>
            ...
            <footer id="contact" className="bg-gray-900 text-white mt-20 border-t-4 border-gray-900">
                <div className="container mx-auto px-6 py-12">
                    <div className="grid md:grid-cols-3 gap-12">
                        <div>
                            <h3 className="text-xl font-bold mb-4 border-b-2 border-gray-700 pb-2 inline-block">R&D Office</h3>
                            <p className="text-gray-400 mb-1">Indian Institute of Technology Guwahati</p>
                            <p className="text-gray-400">Guwahati - 781039, Assam, India</p>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold mb-4 border-b-2 border-gray-700 pb-2 inline-block">Contact</h3>
                            <p className="flex items-center text-gray-300 mb-2"><PhoneIcon className="w-4 h-4 mr-2" /> +91-361-258-XXXX</p>
                            <p className="flex items-center text-gray-300"><MailIcon className="w-4 h-4 mr-2" /> rnd-office@iitg.ac.in</p>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold mb-4 border-b-2 border-gray-700 pb-2 inline-block">Social</h3>
                            <div className="flex space-x-4">
                                {['Twitter', 'LinkedIn', 'YouTube'].map(social => (
                                    <a key={social} href="#" className="text-gray-400 hover:text-white font-bold hover:underline">{social}</a>
                                ))}
                            </div>
                        </div>
                    </div>
