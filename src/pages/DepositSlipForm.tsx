...
const D_CONSULTANCY_FIELDS = [
    ...
    { fieldname: "amount_inclusive_of_gst", label: "Amount Inclusive of GST", fieldtype: "Currency", mandatory: 1, read_only: 0, hidden: 0 },
    { fieldname: "igst_18_on_consultancy", label: "IGST @18% on Consultancy Fee", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "cgst_9_of_consultancy_fee", label: "CGST @9% of Consultancy Fee", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "sgst_9_of_consultancy_fee", label: "SGST @9% of Consultancy Fee", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "income_tax_tds", label: "Income Tax TDS", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "amount_after_gst_tds", label: "GST TDS", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "other_deductions", label: "Other Deductions", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "ammount_actually_received_in_bank", label: "Ammount actually received in bank account", fieldtype: "Currency", read_only: 0, hidden: 0, description: "Calculated as: Amount Inclusive of GST − Income Tax TDS − GST TDS − Other Deductions" },
    { fieldname: "total_cost_x", label: "Total Cost X", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0, description: "Total Cost X (Balance after GST Deduction from amount received)" },
    ...
    { fieldname: "overhead_from_y_amount", label: "Overhead from Y (10% * Y) Amount", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "overhead_from_z_amount", label: "Overhead from Z (10% * Z) Amount", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "total_overhead_amount", label: "Total Overhead ((10% * Y) + (10% * Z)) Amount", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "institute_share_amount", label: "Institute Share (20% * Y) Amount", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "total_overhead_institute_share", label: "Overhead + Institute Share", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "credit_distribution_section", label: "Credit Distribution", fieldtype: "Section Break" },
    { fieldname: "idf_percentage", label: "(A) IDF % age (40%)", fieldtype: "Float", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "idf_amount", label: "IDF Amount", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0, description: "(IDF %age of Overhead + Institute Share)" },
    { fieldname: "student_welfare_amount", label: "(C) Student welfare Amount (5%)", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "staff_welfare_amount", label: "(D) Staff welfare Amount (5%)", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "final_totals", label: "Final Totals", fieldtype: "Section Break" },
    { fieldname: "balance_consultancy_fee", label: "Balance Consultancy Fee", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "balance_operation_charge", label: "Balance Operation Charge", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
    { fieldname: "total_gst", label: "Total GST", fieldtype: "Currency", read_only: 0, hidden: 0, description: "Auto-calculated: IGST @18% + CGST @9% + SGST @9% of Consultancy Fee" },
    { fieldname: "total_amount", label: "Total Amount", fieldtype: "Currency", mandatory: 0, read_only: 0, hidden: 0 },
];
...
const DepositSlipForm: React.FC = () => {
    ...
    // NOTE: D Consultancy has no auto calculation beyond what
    // useDepositSlipCalculations already does for it (Amount Actually
    // Received in Bank and Total GST). Y/Z split, overhead, institute share,
    // IDF/DPF/welfare amounts, and balances are all manual entry fields.
