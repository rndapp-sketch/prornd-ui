...
import { FRAPPE_BASE_URL, FRAPPE_SERVER_IP } from "@/config";
...
const toSameOriginFileUrl = (src: string) => {
  try {
    ...
    if (
      // Old Server Frappe IP check (Commented out):
      // url.hostname === "172.16.131.206" ||
      // Local Development Frappe IP check:
      url.hostname === FRAPPE_SERVER_IP ||
