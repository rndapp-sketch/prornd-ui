            ...
            {(leaveBalance || totalAbsents !== null) && (
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
                    ...
                    {leaveBalance && totalAbsents !== null && totalAbsents > 0 && (
                        <>
                            <div className={`border rounded-xl p-4 flex items-center gap-4 ${actualCL <= 0
                                    ? 'bg-red-50 dark:bg-red-900/10 border-red-200 dark:border-red-800'
                                    : 'bg-emerald-50 dark:bg-emerald-900/10 border-emerald-200 dark:border-emerald-800'
                                }`}>
                                <div className={`h-10 w-10 rounded-lg flex items-center justify-center ${actualCL <= 0
                                        ? 'bg-red-100 dark:bg-red-900/30'
                                        : 'bg-emerald-100 dark:bg-emerald-900/30'
                                    }`}>
                                    <ShieldCheck className={`h-5 w-5 ${actualCL <= 0
                                ...
                                <div>
                                    ...
                                    <p className={`text-2xl font-bold ${actualCL <= 0
                                            ? 'text-red-600 dark:text-red-400'
                            ...
                            <div className={`border rounded-xl p-4 flex items-center gap-4 ${actualEL <= 0
                                    ? 'bg-red-50 dark:bg-red-900/10 border-red-200 dark:border-red-800'
                                    : 'bg-emerald-50 dark:bg-emerald-900/10 border-emerald-200 dark:border-emerald-800'
                                }`}>
                                <div className={`h-10 w-10 rounded-lg flex items-center justify-center ${actualEL <= 0
                                        ? 'bg-red-100 dark:bg-red-900/30'
                                        : 'bg-emerald-100 dark:bg-emerald-900/30'
                                    }`}>
                                    <ShieldCheck className={`h-5 w-5 ${actualEL <= 0
                                            ? 'text-red-600 dark:text-red-400'
                                            : 'text-emerald-600 dark:text-emerald-400'
                                        }`} />
                                </div>
                                <div>
                                    ...
                                    <p className={`text-2xl font-bold ${actualEL <= 0
                                            ? 'text-red-600 dark:text-red-400'
                                            : 'text-emerald-700 dark:text-emerald-300'
                                        }`}>{actualEL}</p>
