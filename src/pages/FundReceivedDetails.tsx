...
const DEPOSIT_SLIP_STATIC_FIELDS: Record<string, any[]> = {
    ...
    d_consultancy: [
        ...
        { fieldname: "gst_tds__2", label: "GST TDS", fieldtype: "Currency", mandatory: false, read_only: false, hidden: false },
        { fieldname: "other_deductions", label: "Other Deductions", fieldtype: "Currency", mandatory: false, read_only: false, hidden: false },
        { fieldname: "amount_actually_received", label: "Amount Actually Received", fieldtype: "Currency", read_only: false, hidden: false, description: "Amount Inclusive of GST − IT TDS − GST TDS − Other Deductions" },
