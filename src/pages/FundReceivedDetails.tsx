...
const DEPOSIT_SLIP_STATIC_FIELDS: Record<string, any[]> = {
    ...
    d_consultancy: [
        ...
        { fieldname: "cgst_9_of_consultancy_fee", label: "CGST @9% of Consultancy Fee", fieldtype: "Currency", mandatory: false, read_only: false, hidden: false },
        { fieldname: "sgst_9_of_consultancy_fee", label: "SGST @9% of Consultancy Fee", fieldtype: "Currency", mandatory: false, read_only: false, hidden: false },
        { fieldname: "income_tax_tds", label: "Income Tax TDS", fieldtype: "Currency", mandatory: false, read_only: false, hidden: false },
        { fieldname: "amount_after_gst_tds", label: "GST TDS", fieldtype: "Currency", mandatory: false, read_only: false, hidden: false },
        { fieldname: "other_deductions", label: "Other Deductions", fieldtype: "Currency", mandatory: false, read_only: false, hidden: false },
        { fieldname: "ammount_actually_received_in_bank", label: "Ammount actually received in bank account", fieldtype: "Currency", read_only: false, hidden: false, description: "Auto: Amount Inclusive of GST − Income Tax TDS − GST TDS − Other Deductions" },
