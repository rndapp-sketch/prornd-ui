...
//         const newId = Date.now().toString() + Math.random().toString(36).substring(2, 9); // Generate a unique ID
//         setFormData(prev => ({
//             ...prev,
...
//                 </div>
//             ) : (
//                 <NeoButton onClick={() => setActiveTab(activeTab + 1)} className={cn("bg-[#A5D6A7]", !showNext && 'invisible')}>
//                     Next Section
//                 </NeoButton>
//             )}
//         </div>
...
//                     <NeoCard className="bg-gray-100 !shadow-[2px_2px_0px_rgba(0,0,0,0.15)]">
//                         <h3 className="text-xl font-bold text-gray-800">Total Projects</h3>
//                         <p className="text-3xl font-extrabold text-black mt-2">123</p>
//                     </NeoCard>
//                     <NeoCard className="bg-gray-100 !shadow-[2px_2px_0px_rgba(0,0,0,0.15)]">
//                         <h3 className="text-xl font-bold text-gray-800">Pending Approvals</h3>
//                         <p className="text-3xl font-extrabold text-black mt-2">15</p>
//                     </NeoCard>
//                     <NeoCard className="bg-gray-100 !shadow-[2px_2px_0px_rgba(0,0,0,0.15)]">
//                         <h3 className="text-xl font-bold text-gray-800">Drafts Saved</h3>
//                         <p className="text-3xl font-extrabold text-black mt-2">7</p>
//                     </NeoCard>
//                 </div> */}
...
//                                 activeTab === index ? "bg-[#90A4AE] text-white" : "bg-white hover:bg-gray-100"
//                             )}
//                         >
//                             {title}
//                         </button>
