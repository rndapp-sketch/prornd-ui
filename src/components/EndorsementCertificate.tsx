...
// Old Server Frappe IP URL (Commented out):
// const DORND_SIGNATURE_SEAL_URL = "http://172.16.131.206:8000/files/Sign_dornd_stamp_rnd.jpg";
// Local Development Frappe IP URL (Centralized via FRAPPE_BASE_URL):
                            ...
                            <tbody>
                                <tr>
                                    <td className="w-[100px] align-top">
                                        {/* Old Server Frappe IP: */}
                                        {/* <img src="http://172.16.131.206:8000/files/IITG_logo.png" alt="IITG Logo" className="w-[90px] h-auto" /> */}
                                        {/* Local Development Frappe IP (Centralized via FRAPPE_BASE_URL): */}
                                        <img
